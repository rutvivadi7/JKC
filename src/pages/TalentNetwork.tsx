...
const TalentNetwork: React.FC = () => {
  ...
  const handleAreasChange = (area: string) => {
    ...
    if (errors.areasOfInterest) {
      setErrors(prev => ({ ...prev, areasOfInterest: false }));
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const selectedAreas = formData.areasOfInterest.join(', ');
      ...
      if (response.success && resumeFile) {
        ...
        fd.append('position', selectedAreas || 'General');
      ...
      if (response.success) {
        setSubmitMessage(
          response.message || 'Thank you for your interest! Your application has been received.'
        );
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-4">
                    <label htmlFor="resume-upload" className="cursor-pointer">
                      <span
                        className={`px-6 py-2 rounded transition-colors inline-block ${
                          errors.resume
                    ...
                    <span className={errors.resume ? 'text-red-500' : 'text-gray-500'}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <input
                      ...
                      className={getInputClasses(
                        'firstName',
                        'w-full px-3 py-3 border rounded focus:outline-none focus:ring-2'
                      )}
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={getInputClasses(
                          'state',
                          'w-full px-3 py-3 border rounded focus:outline-none focus:ring-2 appearance-none bg-white'
                        )}
                      >
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="grid grid-cols-1 gap-6">
                    <div className="relative">
                      <select
                        ...
                        className={getInputClasses(
                          'legallyAuthorized',
                          'w-full px-4 py-5 border rounded focus:outline-none focus:ring-2 appearance-none bg-white text-base'
                        )}
                      >
                        <option value="">
                          Are you legally authorized to work in India for any employer? *
                        </option>
                  ...
                  <div>
                    ...
                    <div
                      className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 border rounded p-4 ${
                        errors.areasOfInterest ? 'border-red-500' : 'border-gray-300'
                      }`}
                    >
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <label htmlFor="agreeToShare" className="text-sm text-gray-700">
                      I agree to share my profile with recruiters and receive occasional
                      emails about new career opportunities. I agree to the{' '}
